...
def _sampling_facts(cfg) -> dict:
    """Plain shape of the training index: how many matches, and how long they are.

    Sampling is uniform over clips -- every within-chunk clip of every match is enumerated, with no
    per-match cap -- so this is a description of the corpus, not a correction applied to it.
    """
